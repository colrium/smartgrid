			...
			<div className="relative z-10 mx-auto flex max-w-[980px] flex-col items-start">
				...
				<div className="mt-8 flex flex-col gap-8 md:flex-row md:items-end md:gap-12">
					...
					<div className="max-w-[620px] pb-4">
						...
						<p className="mt-6 text-base font-light leading-[1.8] text-onSurface-800 md:text-lg">
							{description}
						</p>
						{detail ? (
							<pre className="mt-6 max-h-64 overflow-auto whitespace-pre-wrap rounded border border-primary/20 bg-black/40 p-4 text-xs leading-relaxed text-onSurface-800">
								{detail}
							</pre>
						) : null}
					</div>
