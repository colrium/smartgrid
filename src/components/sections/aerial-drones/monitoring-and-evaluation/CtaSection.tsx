				...
				<FadeUp>
					<div className="relative rounded-[20px] ink-panel card-shadow overflow-hidden px-8 py-16 sm:px-12 sm:py-24 text-center">
						...
						<div className="relative flex flex-col items-center gap-6">
							{section.tag && (
								<span className="inline-flex items-center gap-3 text-[11px] sm:text-xs font-semibold uppercase tracking-[0.22em] text-primary-200">
									<span className="inline-block h-px w-9 bg-primary-200/70" />
									{section.tag}
									<span className="inline-block h-px w-9 bg-primary-200/70" />
								</span>
							)}
