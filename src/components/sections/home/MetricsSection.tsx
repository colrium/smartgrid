			...
			<div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
				<FadeUp>
					<div className="relative rounded-[20px] ink-panel card-shadow overflow-hidden px-8 py-16 sm:px-12 sm:py-20">
						...
						<span className="absolute -top-24 -right-20 w-80 h-80 rounded-full bg-brand-300/40 blur-[90px] pointer-events-none" />
						<span className="absolute -bottom-28 -left-16 w-80 h-80 rounded-full bg-gold-300/25 blur-[90px] pointer-events-none" />
						<span
							className="absolute -left-4 bottom-0 font-light tracking-tighter text-[13rem] leading-none text-white/[0.04] select-none pointer-events-none"
							aria-hidden
						>
