						...
						<FadeUp key={index} delay={(index % 3) * 0.07}>
							...
							>
								<div className="flex items-center justify-between">
									...
									<span className="mdi mdi-arrow-up-right text-xl text-primary opacity-0 -translate-x-1 translate-y-1 transition-all duration-500 group-hover:opacity-100 group-hover:translate-x-0 group-hover:translate-y-0" />
								</div>
								...
								{contact.icon && (
									<span
										className={`absolute -bottom-10 -right-8 text-${contact.color || "on-surface"} opacity-10 pointer-events-none`}
										aria-hidden
									>
										<span
